...
def paginator(request, selections):
...
def create_app(test_config=None):
  ...
  def create_question():
    ...
    current_questions = paginator(request, all_questions)
  ...
  def get_question_by_category(id):
    ...
    try:
      ...
      current_questions = paginator(request, questions)
  ...
  def get_quizzes():
    ...
    try:
      ...
      if len(available_questions) > 0:
        random_number = random.randint(0, len(available_questions) - 1)
        next_question = available_questions[random_number]
